...
user1 = User.create! :name => 'First User', :email => 'user@test.com', :password => '11111111', :password_confirmation => '11111111'
puts 'New user created: ' << user1.name
user2 = User.create! :name => 'Other User', :email => 'otheruser@test.com', :password => '11111111', :password_confirmation => '11111111'
